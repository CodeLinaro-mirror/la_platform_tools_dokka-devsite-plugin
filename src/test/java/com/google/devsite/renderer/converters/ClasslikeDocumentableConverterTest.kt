...
internal class ClasslikeDocumentableConverterTest(private val displayLanguage: Language) :
    ...
    @Test
    fun `Annotation constructors only appear for Kotlin display`() {
        val classlikeJ =
            """
        ...
        kotlinOnly { assertThat(classlikeK.data.publicConstructorsDetails).hasSize(1) }
        javaOnly { assertThat(classlikeK.data.publicConstructorsDetails).isEmpty() }

        // TODO(b/524206735): Java annotations should also have constructors for Kotlin display
        assertThat(classlikeJ.data.publicConstructorsDetails).isEmpty()
    }
