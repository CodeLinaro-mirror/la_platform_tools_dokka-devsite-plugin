...
interface VisibleGrandparentInterface {
    fun grandparentInterfaceFunction(): Unit
}

/** @hide */
interface HiddenParentInterface : VisibleGrandparentInterface {
    fun parentInterfaceFunction(): Unit
}
